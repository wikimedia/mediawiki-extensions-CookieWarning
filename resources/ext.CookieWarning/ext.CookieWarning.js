( function ( mw, $ ) {
	...
	/**
	 * Gets the cookie that the cookiewarning is dismissed, in case the page
	 * has been cached with the warning, or when the warning is controlled by
	 * a geolocation service.
	 */
	function getCookie() {
		return !!mw.cookie.get( 'cookiewarning_dismissed' );
	}
